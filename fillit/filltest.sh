...
./fillit MAPS/valid_6
printf "$GREEN valid_all_pieces_part1$WHITE\n"
./fillit MAPS/valid_all_pieces_part1
printf "$GREEN valid_all_pieces_part2$WHITE\n"
./fillit MAPS/valid_all_pieces_part2
printf "$GREEN valid_all_pieces_part3$WHITE\n"
./fillit MAPS/valid_all_pieces_part3
printf "$GREEN valid_all_pieces_part4$WHITE\n"
./fillit MAPS/valid_all_pieces_part4
