...
/*   Updated: 2019/02/06 13:10:33 by loiberti    ###    #+. /#+    ###.fr     */
/*                                                         /                  */
/*                                                        /                   */
/* ************************************************************************** */
...
void	fill_x_y_axes(t_coord **v2, t_param *param, int i, int j)
{
	while (++i < param->y_max)
	{
...
void	fill_image(t_coord **v2, t_param *p)
{
	int		i;
	int		j;
	double	w;
