...
Pour ce projet, j'ai choisi de mettre en place un algorithme d'heat map, l'idée est d'à partir de l'état actuelle de la grille de déterminer la meilleur position possible où poser sa pièce en fonction de la position de l'adversaire, dans le but de lui rendre impossible le fait de poser plus de pièces.
